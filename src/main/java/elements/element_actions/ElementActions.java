...
public class ElementActions {
    ...
    public int getElementLocationX(@NotNull final By elementLocated) {
        ...
        try {
            ...
            Log4JLogger.logINFO(getClass(), new Exception().getStackTrace()[0].getMethodName(), "Element Location X: " + elementLocationX);
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
    ...
    public int getElementWidth(@NotNull final By elementLocated) {
        ...
        try {
            ...
            Log4JLogger.logINFO(getClass(), new Exception().getStackTrace()[0].getMethodName(), "Element width: " + elementWidth);
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
        return elementWidth;
    ...
    public int getElementLocationY(@NotNull final By elementLocated) {
        ...
        try {
            ...
            Log4JLogger.logINFO(getClass(), new Exception().getStackTrace()[0].getMethodName(), "Element Location Y: " + elementLocationY);
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
    ...
    public int getElementHeight(@NotNull final By elementLocated) {
        ...
        try {
            ...
            Log4JLogger.logINFO(getClass(), new Exception().getStackTrace()[0].getMethodName(), "Element height: " + elementHeight);
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
