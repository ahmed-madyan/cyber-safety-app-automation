...
public class ElementState {
    ...
    public boolean isCheckable(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element checkable: " + isCheckable);
        return isCheckable;
    }
    ...
    public boolean isChecked(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element checked: " + isChecked);
        return isChecked;
    }
    ...
    public boolean isEnabled(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element enabled: " + isEnabled);
        return isEnabled;
    }
    ...
    public boolean isFocusable(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element focusable: " + isFocusable);
        return isFocusable;
    }
    ...
    public boolean isFocused(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element focused: " + isFocused);
        return isFocused;
    }
    ...
    public boolean isLongClickable(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element long-clickable: " + isLongClickable);
    ...
    public boolean isPassword(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element password: " + isPassword);
        return isPassword;
    }
    ...
    public boolean isScrollable(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element scrollable: " + isScrollable);
        return isScrollable;
    }
    ...
    public boolean isDisplayed(@NotNull final By elementLocated) {
        ...
        Log4JLogger.logINFO(getClass(), new Object() {}.getClass().getEnclosingMethod().getName(), "Is element displayed: " + isDisplayed);
        return isDisplayed;
    }
}