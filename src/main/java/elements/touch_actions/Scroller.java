...
class Scroller {
    ...
    protected static void scrollToElement(@NotNull final By elementLocated, @NotNull final TouchDirection direction) {
        Log4JLogger.logINFO(Scroller.class, Thread.currentThread().getName(), "elementLocated: " + elementLocated, "TouchDirection: " + direction);
    ...
    private static boolean scrollUp(@NotNull final By elementLocated) {
        Log4JLogger.logINFO(Scroller.class, Thread.currentThread().getName(), "elementLocated: " + elementLocated);
        boolean isElementDisplayed = false;
