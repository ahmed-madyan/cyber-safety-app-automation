...
public class Verify {
    ...
    public Verify elementCheckable(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is checkable");
        } catch (Exception e) {
    ...
    public Verify elementChecked(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is checked");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementClickable(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is clickable");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementEnabled(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is enabled");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementFocusable(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is focusable");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementFocused(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is focused");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementLongClickable(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is long-clickable");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementPassword(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is password");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementScrollable(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is scrollable");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementSelected(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is selected");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementDisplayed(@NotNull final By elementLocated) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element located with {" + elementLocated + "} is displayed");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementTextToBe(@NotNull final By elementLocated, final String expectedText) {
        try {
            ...
            Exceptions.handle(getClass(), e);
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element text {" + Elements.elementActions().getText(elementLocated).trim() + "} located with {" + elementLocated.toString() + "} is equals to the expected text {" + expectedText.trim() + "}");
        }
        return this;
    }
    ...
    public Verify elementTextContains(@NotNull final By elementLocated, final String expectedText) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Element text {" + Elements.elementActions().getText(elementLocated).trim() + "} located with {" + elementLocated.toString() + "} contains the expected text {" + expectedText.trim() + "}");
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify textToBe(@NotNull final String actualText, @NotNull final String expectedText) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Actual text {" + actualText + "} is equals to the expected text {" + expectedText + "}");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify attributeToBe(@NotNull final String attribute, @NotNull final boolean expected) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Attribute {" + attribute + "} is equals to the expected {" + expected + "}");
        } catch (Exception e) {
           Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify elementAttributeToBe(@NotNull final By elementLocated, @NotNull final String attribute, @NotNull final String value) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Attribute {" + attribute + "} is equals to the expected {" + value + "}");
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify equals(@NotNull final Object actual, @NotNull final Object expected) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Actual {" + actual + "} is equals to the expected {" + expected + "}");
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify notEquals(@NotNull final Object actual, @NotNull final Object expected) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Actual {" + actual + "} not equals to the expected {" + expected + "}");
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
        return this;
    ...
    public Verify assertTrue(@NotNull final boolean condition) {
        try {
            ...
            Log4JLogger.logINFO(Verify.class, new Exception().getStackTrace()[0].getMethodName(), "Actual condition is: {" + condition + "}");
        } catch (Exception e) {
            Exceptions.handle(getClass(), e);
        }
        return this;
