...
public class BrowserStackInitializer {
    ...
    protected static AppiumDriver browserStackInitialization(String platformName) {
        ...
        Log4JLogger.logINFO(BrowserStackInitializer.class, new Object() {}.getClass().getEnclosingMethod().getName(), "platformName: " + platformName);
    ...
    private static void setupManually() {
        Log4JLogger.logINFO(BrowserStackInitializer.class, new Object() {}.getClass().getEnclosingMethod().getName());
        switch (platformName) {
