...
public class BrowserStackBuildIdentifier {
    ...
    public static void generateBuildIdentifierDateTime() {
        ...
        Log4JLogger.logINFO(BrowserStackBuildIdentifier.class, new Object() {}.getClass().getEnclosingMethod().getName(), "Date Time: " + getDateTime());
    ...
    public static void generateBuildNumber() {
        ...
        Log4JLogger.logINFO(BrowserStackBuildIdentifier.class, new Object() {}.getClass().getEnclosingMethod().getName(), "previousBuildNumber" + previousBuildNumber);
        int buildInt = 0;
        ...
        driver.quit();
        Log4JLogger.logINFO(BrowserStackBuildIdentifier.class, new Object() {}.getClass().getEnclosingMethod().getName(), "Build Number: " + getBuildNumber());
    }
}