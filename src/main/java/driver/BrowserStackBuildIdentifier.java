...
public class BrowserStackBuildIdentifier {
    ...
    public static void generateBuildIdentifierDateTime() {
        ...
        Log4JLogger.logINFO(BrowserStackBuildIdentifier.class,"Date Time: " + getDateTime());
    ...
    public static void generateBuildNumber() {
        ...
        Log4JLogger.logINFO(BrowserStackBuildIdentifier.class,"previousBuildNumber" + previousBuildNumber);
        int buildInt = 0;
        ...
        driver.quit();
        Log4JLogger.logINFO(BrowserStackBuildIdentifier.class,"Build Number: " + getBuildNumber());
    }
}