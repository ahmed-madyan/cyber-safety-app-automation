...
public class TermAndConditionsPopUp {
    ...
    public static void validateSkipButtonText() {
        Assertions.hardAssert().elementTextToBe(POP_UP_HEADER, JSONDataManager.getJSONData(TEST_DATA_FILE_PATH, "popUp_SkipButton", JSONDataManager.Types.STRING).toString());
    }
